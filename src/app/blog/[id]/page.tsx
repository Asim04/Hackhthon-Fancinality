...
const page = ({params} : Paramsin) => {
    ...
    <div className=''>
        ...
        <div className="container mx-auto flex justify-between items-center py-4 px-6">
          ...
          <nav className="lg:block hidden">
            ...
            <li><Link href="/our-cheef">Chef</Link></li>
          ...
          <h1><Link href={"/shopping-cart"}><HiOutlineShoppingBag className="text-whitetext text-[24px] cursor-pointer" /></Link> </h1>
          </div>
      ...
      <section
        ...
        style={{ backgroundImage: "url('/Blog/allnav.png')" }}
      >
  ...
  <div className="flex gap-4 mt-6">
    ...
    <div className="flex flex-col justify-center">
      ...
      <h2 className="font-medium text-base text-white cursor-pointer hover:text-yellow-500">
